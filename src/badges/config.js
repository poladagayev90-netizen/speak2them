...
export const BADGE_DEFINITIONS = {
  ...
  comeback: badge({
    id: 'comeback',
    label: 'Comeback Kid',
    description: 'Returned after 7+ days absence',
    conditionText: 'Return after 7+ days away',
    reward: { type: 'trialPremium', value: 1 },
    condition: (userData) => userData.isComeback === true,
  }),
  ai_explorer: badge({
    id: 'ai_explorer',
    label: 'AI Explorer',
    description: 'Used AI feedback 3 times',
    conditionText: 'Use AI feedback 3 times',
    reward: { type: 'unlockFeature', value: 'priority_match' },
    condition: (userData) => (userData.aiFeedbackCount || 0) >= 3,
  }),
  profile_pro: badge({
    id: 'profile_pro',
    label: 'Profile Pro',
    description: 'Filled bio, set level and photo',
    conditionText: 'Add bio, level and photo',
    reward: { type: 'bonusMinutes', value: 5 },
    condition: (userData) => Boolean(userData.bio && userData.level && userData.photo),
  }),
  century: badge({
    id: 'century',
    label: 'Century Club',
