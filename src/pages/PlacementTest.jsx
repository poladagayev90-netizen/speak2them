    ...
    <div className="auth-page" style={{ alignItems: 'flex-start', padding: '40px 16px', overflowY: 'auto' }}>
      <div className="auth-card" style={{ margin: '0 auto', maxWidth: '400px', width: '100%' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
          <div className="auth-logo" style={{ marginBottom: 0 }}>Placement Test</div>
          <span style={{ color: 'var(--text-muted)', fontSize: '13px', fontWeight: 600 }}>
            {currentQuestionIndex + 1} / {placementQuestions.length}
          </span>
        </div>

        <div style={{ height: '4px', background: 'var(--bg-secondary)', borderRadius: '2px', marginBottom: '30px', overflow: 'hidden' }}>
          <div style={{ 
            height: '100%', 
